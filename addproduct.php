                ...
                <div class="card z-depth-0">
                    <div class="card-content">
                        ...
                        <div class="input-field">
                            <div class="input-field">
                                <select id="selectItem">
                                  <option value="0" disabled selected>Select Drug Name</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="input-field center">
                            <button type="submit" class="btn blue btn-large" style="width: 50%" onclick="addProduct()" name="btnAddProduct" id="btnAddProduct">Add Drug</button>
                        </div>
                    </div>
                </div>
            </div>
