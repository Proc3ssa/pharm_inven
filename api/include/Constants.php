...
define('DB_NAME','afabwtbb_pharmacy');   //your database username
define('DB_USER', 'afabwtbb_pharmacy');          //your database name
define('DB_PASS', 'mobango10@');              //your database password
define('DB_HOST', 'localhost'); 


define('WEBSITE_DOMAIN', 'https://pharmacy.projectghana.org/api/public/');
...
define('WEBSITE_NAME', 'AD Pharmacy Management System');                              //your website name here
define('WEBSITE_OWNER_NAME', 'Aziah Daniel');                      //your name, or anyones name, we will send this name with email verification mail.

//This information will be used to genrate the invoice

define('COMPANY_NAME', 'AD Pharmacy');
define('COMPANY_SHORT_NAME', 'ADP');			// Define the company short name that the will print with the invoice number

define('COMPANY_EMAIL', 'info@adpharmacy.com');
define('COMPANY_CONTACT_NUMBER', '+233 545744420');
define('COMPANY_ADDRESS', 'Computer Science, Kumasi Technical University');
...
define('ADMIN_POSITIONS_NAME', array('Admin','Pharmacist','Helper'));	
