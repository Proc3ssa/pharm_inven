            ...
            <div class="col l2 m4 s12">
            	<div class="card hoverable">
            		<div class="card-content blue lighten-1	 white-text">
            			...
            			<p style="font-weight: bold; font-size:20px;">Drugs</p>
            		</div>
            ...
            <div class="col l2 m4 s12">
            	<div class="card hoverable">
            		<div class="card-content blue lighten-1 white-text">
                        ...
                        $todaySalesCount = "SELECT count(*) as count from sells where created_at  LIKE '$date%'";
                        $countquery = mysqli_query($connection,$todaySalesCount);
                        $res = mysqli_fetch_assoc($countquery);
                        
                        echo $res['count'];
                        
                        
                        ?></h3>
            			<p style="font-weight: bold; font-size:20px;">Today's Sale</p>
            		</div>
            		<div class="card-action blue darken-2 center">
            ...
            <div class="col l2 m4 s12">
            	<div class="card hoverable">
            		<div class="card-content blue lighten-1 white-text">
            			...
            			<p style="font-weight: bold; font-size:20px;">Manufacturers</p>
            		</div>
            		<div class="card-action blue darken-2 center">
            			<a class="white-text" href="products">More<i class="material-icons tiny">open_in_new</i></a>
            		</div>
