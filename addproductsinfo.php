    ...
    <div class="socialcodia">
        <div class="row">
            <div class="col l12 s12 m12" style="padding: 30px 0px 30px 10px;">
                <div class="card z-depth-0" style="margin:20px">
                    <div class="card-content">
                        <p class="center card-title" style="font-weight:bold">Add Drug Info</p>
                        <div class="input-field">
                            <input type="text" style="text-transform:uppercase" name="itemName" id="itemName">
                            <label for="itemName">Enter Drug Name</label>
                        </div>
            ...
            <div class="col l6 s12 m6" style="padding: 30px 0px 30px 10px;">
                <div class="card z-depth-0" style="margin:20px">
                    <div class="card-content">
                        <p class="center card-title" style="font-weight:bold">Add Manufacturer</p>
                        <div class="input-field">
                            <input type="text" style="text-transform:uppercase" name="brandName" id="brandName">
                            <label for="brandName">Enter Manufacturer Name</label>
                        </div>
                        <div class="input-field center">
                            <button type="submit" class="btn blue" onclick="addBrand()" name="btnAddBrand" id="btnAddBrand">Add Manufacturer</button>
                        </div>
                    </div>
                </div>
            </div>
